...
// Lightsaber Trail
// ------------------------------------------------------------------------------------------------------------------------
// The trail is from the free asset Pocket RPG https://www.assetstore.unity3d.com/en/#!/content/2458
// which in turn is based on the the Unity Tron Trail of the procedural example code.
// Credits to:
//   Unity Techologies (Tron Trail)
//   Evan Greenwood (Pocket RPG modification)
//
// For the lightsaber code we use the code as it is and create a controller like this:
/*
...
public class LightsaberTrail : MonoBehaviour {
    ...
    */
    ...
    public void UpdateTrail(float currentTime, float deltaTime) { // ** call once a frame **
        ...
        if (mesh == null)
            throw new System.NullReferenceException("Mesh in null");
        // Rebuild the mesh	
        mesh.Clear();
        //
        // Remove old sections
